...
export function ProductCard({ product, quantity, onAdd, onChangeQty, onSetQty }: ProductCardProps) {
  ...
  return (
    <button
      ...
      className={`relative flex items-center bg-white rounded-2xl border transition-all p-2.5 sm:p-3 gap-3 sm:gap-4 cursor-pointer text-left w-full ${isInCart
